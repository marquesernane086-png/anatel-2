      ...
      <div style={{ background: '#071D41' }} className="py-6 px-4">
        <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-center justify-center gap-6">
          ...
          <div className="text-center md:text-left flex items-center gap-4">
            ...
            <div>
              <p className="text-green-300 text-[11px] font-bold uppercase tracking-widest mb-0.5">FISTEL Online — Regularizado</p>
              <h1 className="text-white font-bold text-xl md:text-2xl">Empresa em Dia — Situação Fiscal Regular</h1>
            </div>
          </div>
        </div>
      </div>
